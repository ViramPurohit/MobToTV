...
import com.tv.tv2mob.DeviceListFragment.DeviceActionListener
import java.io.*
...
class DeviceDetailFragment : Fragment(), ConnectionInfoListener {
    ...
    override fun onCreateView(
        ...
        mContentView!!.findViewById<View>(R.id.btn_connect)
            .setOnClickListener {
                ...
                (getActivity() as DeviceActionListener).connect(config)
            }
        mContentView!!.findViewById<View>(R.id.btn_disconnect)
            .setOnClickListener { (getActivity() as DeviceActionListener).disconnect() }
   ...
   override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent) {
        ...
        val serviceIntent = Intent(getActivity(), FileTransferService::class.java)
    ...
    override fun onConnectionInfoAvailable(info: WifiP2pInfo) {
        ...
        view.setText(
            getResources().getString(R.string.group_owner_text)
                    + if (info.isGroupOwner == true) getResources().getString(R.string.yes) else getResources().getString(
                R.string.no
            )
        )
